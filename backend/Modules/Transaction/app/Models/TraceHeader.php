...
class TraceHeader extends Model
{
    ...
    {
        return $this->belongsTo(\Modules\Transaction\Models\BalanceHeader::class, 'id_balance_head', 'id_balance_head');
    }
    ...
    {
        return $this->hasMany(\Modules\Transaction\Models\TraceDetail::class, 'id_trace_head', 'id_trace_head')
                    ->where('status', 1);
    }

    public function materialDocument()
    {
        return $this->hasOne(\Modules\Transaction\Models\MaterialDocument::class, 'id_trace_head', 'id_trace_head');
    }
