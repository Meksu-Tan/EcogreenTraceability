...
use App\Models\ForwardTrace AS FT;
...
class ForwardController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Laratrust::hasRole(['admin', 'super-admin', 'manager', 'superintendent', 'senior-supervisor', 'supervisor', 'senior-staff', 'staff', 'viewer'])) {
            ...
            return view('user.dashboard_forward.index',$data);
        } else {
    ...
    public function show(Request $request, $id)
    {
        ...
        if ($flag == 'get_dtForwardList'){
            $db = RM::get_dtRmList($request);

            return DataTables::of($db)
                    ->addColumn('action', function($data){
                        return view('user.dashboard_forward.datatables.__actionForwardList', [
                            'model'=> $data,
                        ]);
                    })
                    ...
                    ->make(true);
        } elseif ($flag == 'get_dtForwardTrace'){
            $db = FT::get_dtForwardTrace($request);
