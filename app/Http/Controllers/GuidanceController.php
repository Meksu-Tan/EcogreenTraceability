...
class GuidanceController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Laratrust::hasRole(['admin', 'super-admin', 'manager', 'superintendent', 'senior-supervisor', 'supervisor', 'senior-staff', 'staff', 'viewer'])) {
            ...
            //return view('user.guidance.index',$data);
            $path = public_path('pdf/guidance_eudrts.pdf'); // The path to the PDF file

            return Response::make(file_get_contents($path), 200, [
                'Content-Type' => 'application/pdf',
                'Content-Disposition' => 'inline; filename="guidance_eudrts.pdf"',
            ]);
