                        ...
                        <div class="card">
                            <div class="card-body">
                                <form id="form-materialdoc" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="name">Material Document No (SAP)</label>
...
<script>
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    if (data.status == 1) {
                                        ...
                                        // $($dt_cpkoFeed).DataTable().ajax.reload();
                                        // $($dt_daoilRundown).DataTable().ajax.reload();
                                        // $($dt_daoilFeed).DataTable().ajax.reload();

                                        // $($tbl_rundownLog).DataTable().ajax.reload();
                                        // $($tbl_feedLog).DataTable().ajax.reload();
    ...
    /* FUNCTION INITIALIZATION */
        function initialize_materialdoc_modal(){
            $($txt_materialdoc_flag).val('');
            $($txt_materialdoc_mode).val('');
            $($txt_materialdoc_id).val('');
            $($txt_materialdoc_number).val('');
        };

</script>
<?php $__env->stopPush(); ?>
<?php /**PATH C:\XAMPP\htdocs\EODS\Master\resources\views/user/trans_wip/modals/__addMaterialDocModal.blade.php ENDPATH**/ ?>