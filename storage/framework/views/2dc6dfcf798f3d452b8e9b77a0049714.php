<div class="modal fade" data-backdrop="static" data-keyboard="false" style="z-index: 1041" tabindex="-1" role="dialog" id="modal-feedlog">
    <div class="modal-dialog" role="document" style="max-width: 1500px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="header-feedlog"><span> FEED LOGS</span></h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped dataTable no-footer" id="table-feedlog" width="100%" role="grid" aria-describedby="table-1_info">
                                        <thead>
                                            <tr>
                                                <th>Action</th>
                                                <th>Feed Trace No</th>
...
<script>
    ...
    /* VAR INDEX & PARAMETERIZATION */
        const $tbl_feedLog                  = '#table-feedlog';
        const $header_feedLog               = '#header-feedlog';
    ...
    /* FUNCTION AJAX */
        function ajax_dtFeedLog($id, $feedId){
    ...
    /* FUNCTION INITIALIZATION */
        function initialize_feedLogModal($material, $feedId=null){
            $($header_feedLog).html($material + ' FEED LOGS');
            ajax_dtFeedLog($tbl_feedLog, $feedId);
        };
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\XAMPP\htdocs\EODS\Master\resources\views/user/trans_wip/modals/__feedLogModal.blade.php ENDPATH**/ ?>