<div class="modal fade" data-backdrop="static" data-keyboard="false" style="z-index: 1041" tabindex="-1" role="dialog" id="modal-balance">
    <div class="modal-dialog" role="document" style="max-width: 1500px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="balance-header"><span>BALANCE PER BATCHES</span></h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped dataTable no-footer" id="table-balance" width="100%" role="grid" aria-describedby="table-1_info">
                                        <thead>
                                            <tr>
                                                <th>Entry Date</th>
                                                <th>Trace No</th>
                                                ...
                                                <th>Qty Balance (MT)</th>
                                                <th>Supplier / Balance / Init_Qty (MT) / Last_Qty (MT)</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
...
<script>
    ...
    /* VAR INDEX & PARAMETERIZATION */
        const $balance_header        = '#balance-header';
        const $tbl_balance           = '#table-balance';
    ...
    /* FUNCTION AJAX */
        function ajax_dtBalance($id, $rundownId){
    ...
    /* FUNCTION INITIALIZATION */
        function initialize_balanceModal($material, $rundownId){
            $($balance_header).html($material + ' BALANCE PER BATCHES');
            ajax_dtBalance($tbl_balance, $rundownId);
        };
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\XAMPP\htdocs\EODS\Master\resources\views/user/trans_wip/modals/__balanceModal.blade.php ENDPATH**/ ?>