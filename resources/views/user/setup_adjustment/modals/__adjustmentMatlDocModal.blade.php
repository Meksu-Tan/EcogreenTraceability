                        ...
                        <div class="card">
                            <div class="card-body">
                                <form id="form-materialdoc" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="name">Material Document Number</label>
                                        <input type="text" name="number" id="form-materialdoc-number" style="width: 100%;" class="form-control col-sm-12" required autocomplete="off">
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    if (data.status == 1) {
                                        ...
                                        $($modal_adjustmentMatlDoc).modal('hide');
