...
export default {
  ...
  async getBalance(rundownId, params = {}) {
    return this.getData('get_dtBalance', { rundownId, ...params })
  },

  async getFeed(feedId, mode = 'LATEST', params = {}) {
    return this.getData('get_dtFeed', { feedId, mode, ...params })
  },

  async getRundown(rundownId, mode = 'LATEST', params = {}) {
    return this.getData('get_dtRundown', { rundownId, mode, ...params })
  },
